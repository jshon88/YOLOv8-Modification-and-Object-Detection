...
from ObjectDetection2D.modules.yolomodels import create_yolomodel, freeze_yolomodel
...
def create_detectionmodel(modelname, num_classes=None, trainable_layers=0, ckpt_file = None, fp16=False, device= 'cuda:0', scale='n', is_modified=False):
    model = None
    preprocess = None
    classes = None
    ...
    if modelname == 'fasterrcnn_resnet50_fpn_v2':
        ...
        model, preprocess, classes=create_yolomodel(modelname, num_classes, ckpt_file, fp16, device, scale, is_modified=is_modified)

...
import math
import sys
sys.path.append('/data/cmpe258-sp24/017553289/cmpe249')
import torch
import torch.utils.data
import torchvision
import torchvision.models.detection

from ObjectDetection2D import utils
from ObjectDetection2D.trainutils import create_aspect_ratio_groups, GroupedBatchSampler

from ObjectDetection2D.dataset import get_dataset #get_cocodataset, get_kittidataset, get_transform
from ObjectDetection2D.models import create_detectionmodel #get_torchvision_detection_models, modify_fasterrcnnheader
from ObjectDetection2D.myevaluator import simplemodelevaluate, modelevaluate, yoloevaluate
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/data/cmpe258-sp24/017553289/cmpe249/dataset/Kitti/", type=str, help="dataset path") #/data/cmpe249-fa23/waymotrain200cocoyolo/, /data/cmpe249-fa23/coco/
    parser.add_argument("--annotationfile", default=None, type=str, help="dataset annotion file path, e.g., coco json file")
    parser.add_argument(
        "--dataset",
        default="yolo", 
        type=str,
    ...
    parser.add_argument("--scale", default="n", type=str, help="model scale: n, x") 
    parser.add_argument("--ckpt", default="/data/cmpe258-sp24/017553289/cmpe249/ObjectDetection2D/yolov8n.pt", type=str, help="model name") #"/data/cmpe249-fa23/modelzoo/yolov8n_statedicts.pt"
    ...
    parser.add_argument("--output-dir", default="/data/cmpe258-sp24/017553289/cmpe249/ObjectDetection2D/results", type=str, help="path to save outputs")
    parser.add_argument("--resume", default=None, type=str, help="path of checkpoint") #/data/cmpe249-fa23/trainoutput/yolo/yolov8x0318/model_25.pth
    parser.add_argument("--modified", default=False, type=bool, help="Backbone modified")
    ...
    parser.add_argument("--expname", default="experiment2", help="experiment name, create a sub-folder")
...
def main(args):
    ...
    model, preprocess, classes = create_detectionmodel(args.model, num_classes, args.trainable, ckpt_file=args.ckpt, fp16=False, device= device, scale=args.scale, is_modified=args.modified)
    #model.to(device)
    ...
    if args.test_only:
        ...
        yoloevaluate(model, data_loader_test, preprocess, device, epoch)
